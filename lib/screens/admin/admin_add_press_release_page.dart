...
class AdminAddPressReleasePage extends StatefulWidget {
  final String userId;
  final DocumentSnapshot userData;
  const AdminAddPressReleasePage(
      {super.key, required this.userId, required this.userData});

  @override
  State<AdminAddPressReleasePage> createState() =>
      _AdminAddPressReleasePageState();
}

class _AdminAddPressReleasePageState extends State<AdminAddPressReleasePage> {
