...
class AdminSinglePressView extends StatefulWidget {
  final String userId;
  final DocumentSnapshot userData;
  final DocumentSnapshot pressData;
  const AdminSinglePressView(
      {super.key,
  ...
  @override
  State<AdminSinglePressView> createState() => _AdminSinglePressViewState();
}

class _AdminSinglePressViewState extends State<AdminSinglePressView> {
  String language = '';
