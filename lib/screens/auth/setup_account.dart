...
import '../../screens/auth/setup_company_page.dart';
import '../../screens/auth/setup_journalist_page.dart';
import '../../screens/auth/setup_unknown_page.dart';
...
class _SetUpAccountPageState extends State<SetUpAccountPage> {
      ...
      if (snapshot.exists) {
        if (mounted) {
          setState(() {
            ...
            registrationNo = snapshot['user_registration_number'];
            judet = snapshot['user_judet'];
            adresa = snapshot['user_adresa'];
  ...
  decider(DocumentSnapshot userData) {
    if (userData['user_account_type'] == 'Company') {
      return SetupCompanyPage(
        userId: widget.userId,
        // userData: userData,
      );
    } else if (userData['user_account_type'] == 'Journalist') {
