...
import '../admin/admin_update_profile.dart';
  ...
  void _getUserData(String userId) {
    _subscription = FirebaseFirestore.instance
      ...
      if (mounted) {
        setState(() {
          _userData = snapshot;
          language = snapshot['user_language'];
        });
      }
    });
  }
                              ...
                              Column(
                                ...
                                children: [
                                  blackBoldTextWithSize(
                                      _userData!['user_name'], 18),
                                  addVerticalSpace(6.0),
                                  blackBioText(_userData!['about_user'])
                                ],
                              ),
                            ],
                          ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            profileTiles(
                              language == 'ro'
                                  ? 'Limba (${_userData!['user_language']})'
                                  : 'Language (${_userData!['user_language']})',
                              language == 'ro'
                            ...
                            Row(
                              children: [
                                black54BoldText(
                                  language == 'ro'
                                      ? 'Abonament: ${_userData!['user_plan'] == '-' ? 'DEMO' : _userData!['user_plan']}'
                                      : 'Subscription: ${_userData!['user_plan'] == '-' ? 'DEMO' : _userData!['user_plan']}',
                                ),
                              ],
                            ),
                            // Row(
                            ...
                            //             CircularSegmentEntry(
                            //               (_userData!['interview_left_count'] /
                            //                       total) *
                            //                   100,
                            //               Colors.blue[400],
                            //               rankKey: 'completed',
                            ...
                            //               language == 'ro'
                            //                   ? '${_userData!['press_left_count']} Comunicate de presă'
                            //                   : '${_userData!['press_left_count']} Press releases',
                            //               Colors.red),
                            //           bulletColoredBlackText(
                            //               language == 'ro'
                            //                   ? '${_userData!['interview_left_count']} Interviuri'
                            //                   : '${_userData!['interview_left_count']} Interviews',
                            //               Colors.blue),
                            //           bulletColoredBlackText(
                            //               language == 'ro'
                            //                   ? '${_userData!['event_left_count']} Evenimente de presă'
                            //                   : '${_userData!['event_left_count']} Press events',
                            //               Colors.green),
                            //         ],
                            //       ),
                            //     )
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              openLogoutDialog(_userData!['user_language']);
                            },
                            child: tealButton(
