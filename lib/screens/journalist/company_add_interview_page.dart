...
class CompanyAddInterviewPage extends StatefulWidget {
  final String userId;
  final DocumentSnapshot userData;
  const CompanyAddInterviewPage(
      {super.key, required this.userId, required this.userData});

  @override
  State<CompanyAddInterviewPage> createState() =>
      _CompanyAddInterviewPageState();
}

class _CompanyAddInterviewPageState extends State<CompanyAddInterviewPage> {
  ...
  Future<void> _uploadImage(BuildContext context) async {
    ...
    try {
      Reference pressStorageReference = FirebaseStorage.instance.ref().child(
          'Articles/Interviews/$year/${now.millisecondsSinceEpoch.toString()}.jpg');
