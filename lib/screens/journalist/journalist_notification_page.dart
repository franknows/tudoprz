...
class JournalistNotificationsPage extends StatefulWidget {
  final String userId;
  final DocumentSnapshot myUserInfo;
  const JournalistNotificationsPage(
      {super.key, required this.userId, required this.myUserInfo});

  @override
  State<JournalistNotificationsPage> createState() =>
      _JournalistNotificationsPageState();
}

class _JournalistNotificationsPageState
    extends State<JournalistNotificationsPage> {
