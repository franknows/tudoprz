...
whiteNormalTextMaxLines(String txt, int i) {
  return Text(
    txt,
    style: GoogleFonts.quicksand(
      fontSize: 14,
...
blackBoldTextMaxLines(String txt, int i) {
  return Text(
    txt,
    style: GoogleFonts.quicksand(
      fontSize: 14,
...
Widget simpleErrorDarkRoundedButton(String text) {
  return Container(
    height: 40.0,
    width: double.infinity,
    decoration: BoxDecoration(
...
eventAdminApproveItem(DocumentSnapshot doc, String userId) {
  return Padding(
    padding: const EdgeInsets.only(bottom: 12.0),
    child: Container(
      decoration: BoxDecoration(
...
adAdminApproveItem(DocumentSnapshot doc, String userId) {
  return Padding(
    padding: const EdgeInsets.only(bottom: 12.0),
    child: Container(
      decoration: BoxDecoration(
